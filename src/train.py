...
# ── INTENTIONAL SYNTAX ERROR — triggers failure() handler ────
# Remove this line after capturing the error_logs artifact screenshot
raise RuntimeError("Intentional failure to test error_logs artifact upload")
